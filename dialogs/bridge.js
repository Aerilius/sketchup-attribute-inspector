...
var _requestHandler = __webpack_require__(/*! ./request-handler.js */ "./src/js/request-handler.js");

var _requestHandler2 = _interopRequireDefault(_requestHandler);

var _requestHandlerWebdialog = __webpack_require__(/*! ./request-handler-webdialog.js */ "./src/js/request-handler-webdialog.js");

var _requestHandlerWebdialog2 = _interopRequireDefault(_requestHandlerWebdialog);

var _requestHandlerHtmldialog = __webpack_require__(/*! ./request-handler-htmldialog.js */ "./src/js/request-handler-htmldialog.js");

var _requestHandlerHtmldialog2 = _interopRequireDefault(_requestHandlerHtmldialog);

var _requestHandlerBrowserPrompt = __webpack_require__(/*! ./request-handler-browser-prompt.js */ "./src/js/request-handler-browser-prompt.js");

var _requestHandlerBrowserPrompt2 = _interopRequireDefault(_requestHandlerBrowserPrompt);
...
function isSketchUp() {
  return (typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && _typeof(window.navigator) === 'object' && /SketchUp/.test(window.navigator.userAgent);
}
...
function analyzeErrorStringAndMetadata(message) {
  var metadata = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

  var type = metadata.type || 'Error';
  var trace = metadata.filename ? metadata.filename : metadata.url ? metadata.url : getWindowFileOrUrl();
  if (metadata.lineNumber) {
    trace += ':' + metadata.lineNumber + (metadata.columnNumber ? metadata.columnNumber : '') + ': in JavaScript function';
  }
  var backtrace = [trace];
  return { type: type, message: message, backtrace: backtrace };
}

function analyzeErrorObject(errorObject) {
  var type = errorObject.name;
  var message = errorObject.message || errorObject.description;
  var trace = errorObject.filename ? errorObject.filename : getWindowFileOrUrl();
...
var BridgeClass = exports.BridgeClass = function () {
  function BridgeClass(requestHandler) {
    _classCallCheck(this, BridgeClass);
  ...
  _createClass(BridgeClass, [{
            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return _context.abrupt('return', new Promise(function (resolve, reject) {
                  return _this.requestHandler.send(message, function (_ref2) {
    ...
    key: 'error',
    value: function error(textOrError, metadata) {
      var type = void 0,
          message = void 0,
          backtrace = void 0;
      if (typeof textOrError === 'string') {
        ;
        var _analyzeErrorStringAn = analyzeErrorStringAndMetadata(textOrError, metadata = {});

        type = _analyzeErrorStringAn.type;
        message = _analyzeErrorStringAn.message;
        backtrace = _analyzeErrorStringAn.backtrace;
      } else if (textOrError instanceof Error) {
        ;
        var _analyzeErrorObject = analyzeErrorObject(textOrError);

        type = _analyzeErrorObject.type;
        message = _analyzeErrorObject.message;
        backtrace = _analyzeErrorObject.backtrace;
      } else {
...
if (isSketchUp()) {
  if (isSketchUpHtmDialog()) {
    requestHandler = new _requestHandlerHtmldialog2.default();
  } else {
    requestHandler = new _requestHandlerWebdialog2.default(window.location);
  }
} else {
...
/***/ "./src/js/request-handler-browser-prompt.js":
/*!**************************************************!*\
  !*** ./src/js/request-handler-browser-prompt.js ***!
  \**************************************************/
/*! no static exports found */
...
var BrowserPromptRequestHandler = function (_RequestHandler) {
  _inherits(BrowserPromptRequestHandler, _RequestHandler);

  function BrowserPromptRequestHandler() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$messageIdGenerat = _ref.messageIdGenerator,
        messageIdGenerator = _ref$messageIdGenerat === undefined ? new _requestHandler.IdGenerator() : _ref$messageIdGenerat;

    _classCallCheck(this, BrowserPromptRequestHandler);
     ...
     */
    var _this = _possibleConstructorReturn(this, (BrowserPromptRequestHandler.__proto__ || Object.getPrototypeOf(BrowserPromptRequestHandler)).call(this, { messageIdGenerator: messageIdGenerator }));

    _this.mockCallbacks = {};
    return _this;
  }

  _createClass(BrowserPromptRequestHandler, [{
    key: 'mockRequests',
    value: function mockRequests(mocks) {
  ...
  return BrowserPromptRequestHandler;
}(_requestHandler2.default);

exports.default = BrowserPromptRequestHandler;

/***/ }),

/***/ "./src/js/request-handler-htmldialog.js":
/*!**********************************************!*\
  !*** ./src/js/request-handler-htmldialog.js ***!
  \**********************************************/
/*! no static exports found */
...
var CALLBACKNAME = 'LoginSuccess'; // 'Bridge.receive'

var HtmlDialogRequestHandler = function (_RequestHandler) {
  _inherits(HtmlDialogRequestHandler, _RequestHandler);

  function HtmlDialogRequestHandler() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$sketchup = _ref.sketchup,
        sketchup = _ref$sketchup === undefined ? window.sketchup : _ref$sketchup,
        _ref$messageIdGenerat = _ref.messageIdGenerator,
        messageIdGenerator = _ref$messageIdGenerat === undefined ? new _requestHandler.IdGenerator() : _ref$messageIdGenerat;

    _classCallCheck(this, HtmlDialogRequestHandler);

    var _this = _possibleConstructorReturn(this, (HtmlDialogRequestHandler.__proto__ || Object.getPrototypeOf(HtmlDialogRequestHandler)).call(this, { messageIdGenerator: messageIdGenerator }));

    _this.sketchup = sketchup;
    return _this;
  }
  ...
  _createClass(HtmlDialogRequestHandler, [{
    key: 'send',
    value: function send(message, callback) {
  ...
  return HtmlDialogRequestHandler;
}(_requestHandler2.default);

exports.default = HtmlDialogRequestHandler;

/***/ }),

/***/ "./src/js/request-handler-webdialog.js":
/*!*********************************************!*\
  !*** ./src/js/request-handler-webdialog.js ***!
  \*********************************************/
/*! no static exports found */
 ...
 * @constant {string}
 */
var URL_RECEIVE = 'skp:LoginSuccess'; // TODO: channge to Bridge.receive

var INPUT_FIELD_ID = 'Bridge.requestField';
...
var WebDialogRequestHandler = function (_RequestHandler) {
  _inherits(WebDialogRequestHandler, _RequestHandler);

  function WebDialogRequestHandler() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$location = _ref.location,
        location = _ref$location === undefined ? window.location : _ref$location,
        _ref$messageIdGenerat = _ref.messageIdGenerator,
        messageIdGenerator = _ref$messageIdGenerat === undefined ? new _requestHandler.IdGenerator() : _ref$messageIdGenerat,
        _ref$hiddenInputField = _ref.hiddenInputField,
        hiddenInputField = _ref$hiddenInputField === undefined ? createMessageField(INPUT_FIELD_ID) : _ref$hiddenInputField;

    _classCallCheck(this, WebDialogRequestHandler);

    var _this = _possibleConstructorReturn(this, (WebDialogRequestHandler.__proto__ || Object.getPrototypeOf(WebDialogRequestHandler)).call(this, { messageIdGenerator: messageIdGenerator }));
     ...
     */
    _this.hiddenInputField = hiddenInputField;
    /**
  ...
  _createClass(WebDialogRequestHandler, [{
    key: 'ack',
    value: function ack(id) {
      this.running = false; // Ready to send new messages.
      (0, _requestHandler.cleanUpScripts)();
    ...
    key: 'enQueue',
    value: function enQueue(message, callback) {
      // We assign an id to this message so we can identify a callback (if there is one).
      var id = message.id = this.messageIdGenerator.next();
      this.handlers[id] = callback;
    ...
    value: function submit(message) {
      ...
      setTimeout(function () {
        return _this2.location.href = URL_RECEIVE;
      }, 0);
    }
  }, {
    key: 'send',
  ...
  return WebDialogRequestHandler;
}(_requestHandler2.default);

exports.default = WebDialogRequestHandler;

/***/ }),

/***/ "./src/js/request-handler.js":
/*!***********************************!*\
  !*** ./src/js/request-handler.js ***!
  \***********************************/
/*! no static exports found */
...
exports.cleanUpScripts = cleanUpScripts;
...
function extendError(error, id, handlerName, handler) {
  error.message = 'Bridge.RequestHandler.receive: Error when executing handler `' + handlerName + '` (' + id + '): ' + error.message;
  if (!error.stack) error.stack = handler.toString();
}

function resolveObjectPath(objectPathString) {
  return objectPathString.split('.').reduce(function (agg, val) {
    return agg[val];
  }, global);
}
...
var RequestHandler = function () {
  function RequestHandler() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$messageIdGenerat = _ref.messageIdGenerator,
        messageIdGenerator = _ref$messageIdGenerat === undefined ? new IdGenerator() : _ref$messageIdGenerat;
  ...
  _createClass(RequestHandler, [{
    key: 'receive',
    value: function receive(id, response) {
      ...
      if (this.handlers[id]) {
        ...
        console.warn('RequestHandler does not know a callback for received response with id=' + id + ': ' + response);
      }
      cleanUpScripts();
    }
  }, {
    key: 'get',
    value: function get(callbackHandlerName, functionName) {
...
/***/ 0:
/*!***********************************************!*\
  !*** multi babel-polyfill ./src/js/bridge.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/js/bridge.js */"./src/js/bridge.js");
