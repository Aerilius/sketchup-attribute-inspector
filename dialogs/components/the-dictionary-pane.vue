<template>
  <div class="the-dictionary-pane">
    ...
    <div class="a11ytree dictionary-list">
      <TreeView v-show="!_isEmpty(dictionaries)" 
                 ref="treeView" 
    ...
    <Toolbar class="bottom-toolbar">
      <ToolbarButton :title="tr('Add a new dictionary')" image="../images/plus.svg" 
                      @click.native="onAddDictionary" :disabled="!dictionaries" />
      <ToolbarButton :title="tr('Add a nested dictionary')" image="../images/plus-nested.svg" 
                      @click.native="onAddNestedDictionary" :disabled="_isEmpty(dictionaries) || _isEmpty(selectedPath)" />
      <ToolbarButton :title="tr('Rename the selected dictionary')" image="../images/rename.svg" 
                      @click.native="onRenameDictionary" :disabled="_isEmpty(dictionaries) || _isEmpty(selectedPath)" />
      <ToolbarButton :title="tr('Remove the selected dictionary')" image="../images/minus.svg" 
